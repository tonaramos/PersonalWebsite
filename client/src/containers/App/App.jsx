  ...
  constructor(props) {
    ...
    this.state = {
      ...
      projects: [{
        ...
        description: 'Redesigned and scaled the back-end API of an Open Table reviews component to properly handle over 200rps with over 70M records of user data and reduce the initial page load time to under 1000ms. The microservice implements React, server-side rendering, a Redis chace system, and a Postgres database. Tested with Artillery.io, Loadder.io, and New Relic to analyze the response times of the server and database for potential bottlenecks.',
        ...
        description: 'Used React.js to develop and design a user interface identical to Airbnb which displays a property description listing, amenities, rules, room arrangements, and unique characteristics and attributes of properties that meet certain criteria. Created a Mongo database hosted in Mlab flexible to handle and store the different size contents of each property for thousands of records.',
        ...
        description: 'Single page application with a multi-page feeling that incorporates routing, form validation, and authentication. Using redux for data management and tested with Jest and Enzyme this online ordering system is optimized for all screen sizes and a seamless ordering experience.',
        ...
        description: 'Built with React and Redux, this single page website showcases a short description about me, my projects, a picture gallery, a contact form, links to other social media profiles and a node/express server with Sendgrid for email delivery.',
